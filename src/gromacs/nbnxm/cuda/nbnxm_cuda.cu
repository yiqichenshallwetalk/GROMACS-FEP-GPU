 ...
 */
 ...
 /*! Force only kernel function pointers. */
 static const nbnxn_fep_cu_kfunc_ptr_t nb_fep_kfunc_noener_ptr[c_numElecTypes][c_numVdwTypes] = {
   { nbnxn_fep_kernel_ElecCut_VdwLJ_F_cuda,
     nbnxn_fep_kernel_ElecCut_VdwLJCombGeom_F_cuda,
     nbnxn_fep_kernel_ElecCut_VdwLJCombLB_F_cuda,
     nbnxn_fep_kernel_ElecCut_VdwLJFsw_F_cuda,
     nbnxn_fep_kernel_ElecCut_VdwLJPsw_F_cuda,
     nbnxn_fep_kernel_ElecCut_VdwLJEwCombGeom_F_cuda,
     nbnxn_fep_kernel_ElecCut_VdwLJEwCombLB_F_cuda },
   { nbnxn_fep_kernel_ElecRF_VdwLJ_F_cuda,
     nbnxn_fep_kernel_ElecRF_VdwLJCombGeom_F_cuda,
     nbnxn_fep_kernel_ElecRF_VdwLJCombLB_F_cuda,
     nbnxn_fep_kernel_ElecRF_VdwLJFsw_F_cuda,
     nbnxn_fep_kernel_ElecRF_VdwLJPsw_F_cuda,
     nbnxn_fep_kernel_ElecRF_VdwLJEwCombGeom_F_cuda,
     nbnxn_fep_kernel_ElecRF_VdwLJEwCombLB_F_cuda },
   { nbnxn_fep_kernel_ElecEwQSTab_VdwLJ_F_cuda,
     nbnxn_fep_kernel_ElecEwQSTab_VdwLJCombGeom_F_cuda,
     nbnxn_fep_kernel_ElecEwQSTab_VdwLJCombLB_F_cuda,
     nbnxn_fep_kernel_ElecEwQSTab_VdwLJFsw_F_cuda,
     nbnxn_fep_kernel_ElecEwQSTab_VdwLJPsw_F_cuda,
     nbnxn_fep_kernel_ElecEwQSTab_VdwLJEwCombGeom_F_cuda,
     nbnxn_fep_kernel_ElecEwQSTab_VdwLJEwCombLB_F_cuda },
   { nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJ_F_cuda,
     nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJCombGeom_F_cuda,
     nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJCombLB_F_cuda,
     nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJFsw_F_cuda,
     nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJPsw_F_cuda,
     nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJEwCombGeom_F_cuda,
     nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJEwCombLB_F_cuda },
   { nbnxn_fep_kernel_ElecEw_VdwLJ_F_cuda,
     nbnxn_fep_kernel_ElecEw_VdwLJCombGeom_F_cuda,
     nbnxn_fep_kernel_ElecEw_VdwLJCombLB_F_cuda,
     nbnxn_fep_kernel_ElecEw_VdwLJFsw_F_cuda,
     nbnxn_fep_kernel_ElecEw_VdwLJPsw_F_cuda,
     nbnxn_fep_kernel_ElecEw_VdwLJEwCombGeom_F_cuda,
     nbnxn_fep_kernel_ElecEw_VdwLJEwCombLB_F_cuda },
   { nbnxn_fep_kernel_ElecEwTwinCut_VdwLJ_F_cuda,
     nbnxn_fep_kernel_ElecEwTwinCut_VdwLJCombGeom_F_cuda,
     nbnxn_fep_kernel_ElecEwTwinCut_VdwLJCombLB_F_cuda,
     nbnxn_fep_kernel_ElecEwTwinCut_VdwLJFsw_F_cuda,
     nbnxn_fep_kernel_ElecEwTwinCut_VdwLJPsw_F_cuda,
     nbnxn_fep_kernel_ElecEwTwinCut_VdwLJEwCombGeom_F_cuda,
     nbnxn_fep_kernel_ElecEwTwinCut_VdwLJEwCombLB_F_cuda }
 };

 /*! Force + energy kernel function pointers. */
 static const nbnxn_fep_cu_kfunc_ptr_t nb_fep_kfunc_ener_ptr[c_numElecTypes][c_numVdwTypes] = {
   { nbnxn_fep_kernel_ElecCut_VdwLJ_VF_cuda,
     nbnxn_fep_kernel_ElecCut_VdwLJCombGeom_VF_cuda,
     nbnxn_fep_kernel_ElecCut_VdwLJCombLB_VF_cuda,
     nbnxn_fep_kernel_ElecCut_VdwLJFsw_VF_cuda,
     nbnxn_fep_kernel_ElecCut_VdwLJPsw_VF_cuda,
     nbnxn_fep_kernel_ElecCut_VdwLJEwCombGeom_VF_cuda,
     nbnxn_fep_kernel_ElecCut_VdwLJEwCombLB_VF_cuda },
   { nbnxn_fep_kernel_ElecRF_VdwLJ_VF_cuda,
     nbnxn_fep_kernel_ElecRF_VdwLJCombGeom_VF_cuda,
     nbnxn_fep_kernel_ElecRF_VdwLJCombLB_VF_cuda,
     nbnxn_fep_kernel_ElecRF_VdwLJFsw_VF_cuda,
     nbnxn_fep_kernel_ElecRF_VdwLJPsw_VF_cuda,
     nbnxn_fep_kernel_ElecRF_VdwLJEwCombGeom_VF_cuda,
     nbnxn_fep_kernel_ElecRF_VdwLJEwCombLB_VF_cuda },
   { nbnxn_fep_kernel_ElecEwQSTab_VdwLJ_VF_cuda,
     nbnxn_fep_kernel_ElecEwQSTab_VdwLJCombGeom_VF_cuda,
     nbnxn_fep_kernel_ElecEwQSTab_VdwLJCombLB_VF_cuda,
     nbnxn_fep_kernel_ElecEwQSTab_VdwLJFsw_VF_cuda,
     nbnxn_fep_kernel_ElecEwQSTab_VdwLJPsw_VF_cuda,
     nbnxn_fep_kernel_ElecEwQSTab_VdwLJEwCombGeom_VF_cuda,
     nbnxn_fep_kernel_ElecEwQSTab_VdwLJEwCombLB_VF_cuda },
   { nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJ_VF_cuda,
     nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJCombGeom_VF_cuda,
     nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJCombLB_VF_cuda,
     nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJFsw_VF_cuda,
     nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJPsw_VF_cuda,
     nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJEwCombGeom_VF_cuda,
     nbnxn_fep_kernel_ElecEwQSTabTwinCut_VdwLJEwCombLB_VF_cuda },
   { nbnxn_fep_kernel_ElecEw_VdwLJ_VF_cuda,
     nbnxn_fep_kernel_ElecEw_VdwLJCombGeom_VF_cuda,
     nbnxn_fep_kernel_ElecEw_VdwLJCombLB_VF_cuda,
     nbnxn_fep_kernel_ElecEw_VdwLJFsw_VF_cuda,
     nbnxn_fep_kernel_ElecEw_VdwLJPsw_VF_cuda,
     nbnxn_fep_kernel_ElecEw_VdwLJEwCombGeom_VF_cuda,
     nbnxn_fep_kernel_ElecEw_VdwLJEwCombLB_VF_cuda },
   { nbnxn_fep_kernel_ElecEwTwinCut_VdwLJ_VF_cuda,
     nbnxn_fep_kernel_ElecEwTwinCut_VdwLJCombGeom_VF_cuda,
     nbnxn_fep_kernel_ElecEwTwinCut_VdwLJCombLB_VF_cuda,
     nbnxn_fep_kernel_ElecEwTwinCut_VdwLJFsw_VF_cuda,
     nbnxn_fep_kernel_ElecEwTwinCut_VdwLJPsw_VF_cuda,
     nbnxn_fep_kernel_ElecEwTwinCut_VdwLJEwCombGeom_VF_cuda,
     nbnxn_fep_kernel_ElecEwTwinCut_VdwLJEwCombLB_VF_cuda }
 };

 /*! Return a pointer to the kernel version to be executed at the current step. */
 static inline nbnxn_fep_cu_kfunc_ptr_t select_nbnxn_fep_kernel(enum ElecType           elecType,
                                                                 enum VdwType            vdwType,
                                                                 bool                    bDoEne,
                                                                 const DeviceInformation gmx_unused* deviceInfo)
 {
 ...
 static const nbnxn_foreign_fep_cu_kfunc_ptr_t nb_foreign_fep_kfunc_ptr[c_numElecTypes][c_numVdwTypes] = {
   { nbnxn_foreign_fep_kernel_ElecCut_VdwLJ_V_cuda,
     nbnxn_foreign_fep_kernel_ElecCut_VdwLJCombGeom_V_cuda,
     nbnxn_foreign_fep_kernel_ElecCut_VdwLJCombLB_V_cuda,
     nbnxn_foreign_fep_kernel_ElecCut_VdwLJFsw_V_cuda,
     nbnxn_foreign_fep_kernel_ElecCut_VdwLJPsw_V_cuda,
     nbnxn_foreign_fep_kernel_ElecCut_VdwLJEwCombGeom_V_cuda,
     nbnxn_foreign_fep_kernel_ElecCut_VdwLJEwCombLB_V_cuda },
   { nbnxn_foreign_fep_kernel_ElecRF_VdwLJ_V_cuda,
     nbnxn_foreign_fep_kernel_ElecRF_VdwLJCombGeom_V_cuda,
     nbnxn_foreign_fep_kernel_ElecRF_VdwLJCombLB_V_cuda,
     nbnxn_foreign_fep_kernel_ElecRF_VdwLJFsw_V_cuda,
     nbnxn_foreign_fep_kernel_ElecRF_VdwLJPsw_V_cuda,
     nbnxn_foreign_fep_kernel_ElecRF_VdwLJEwCombGeom_V_cuda,
     nbnxn_foreign_fep_kernel_ElecRF_VdwLJEwCombLB_V_cuda },
   { nbnxn_foreign_fep_kernel_ElecEwQSTab_VdwLJ_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwQSTab_VdwLJCombGeom_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwQSTab_VdwLJCombLB_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwQSTab_VdwLJFsw_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwQSTab_VdwLJPsw_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwQSTab_VdwLJEwCombGeom_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwQSTab_VdwLJEwCombLB_V_cuda },
   { nbnxn_foreign_fep_kernel_ElecEwQSTabTwinCut_VdwLJ_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwQSTabTwinCut_VdwLJCombGeom_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwQSTabTwinCut_VdwLJCombLB_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwQSTabTwinCut_VdwLJFsw_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwQSTabTwinCut_VdwLJPsw_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwQSTabTwinCut_VdwLJEwCombGeom_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwQSTabTwinCut_VdwLJEwCombLB_V_cuda },
   { nbnxn_foreign_fep_kernel_ElecEw_VdwLJ_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEw_VdwLJCombGeom_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEw_VdwLJCombLB_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEw_VdwLJFsw_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEw_VdwLJPsw_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEw_VdwLJEwCombGeom_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEw_VdwLJEwCombLB_V_cuda },
   { nbnxn_foreign_fep_kernel_ElecEwTwinCut_VdwLJ_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwTwinCut_VdwLJCombGeom_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwTwinCut_VdwLJCombLB_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwTwinCut_VdwLJFsw_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwTwinCut_VdwLJPsw_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwTwinCut_VdwLJEwCombGeom_V_cuda,
     nbnxn_foreign_fep_kernel_ElecEwTwinCut_VdwLJEwCombLB_V_cuda }
 };

 /*! Return a pointer to the kernel version to be executed at the current step. */
 static inline nbnxn_foreign_fep_cu_kfunc_ptr_t select_nbnxn_foreign_fep_kernel(enum ElecType           elecType,
   enum VdwType            vdwType,
   const DeviceInformation gmx_unused* deviceInfo)
 {
     const int elecTypeIdx = static_cast<int>(elecType);
 ...
 void gpu_launch_kernel(NbnxmGpu* nb, const gmx::StepWorkload& stepWork, const InteractionLocality iloc)
 {
     ...
     if (bFEP)
     {
         ...
         if (feplist->nri == 0) {
           if (bDoTime)
           {
             timers->interaction[iloc].fep_k.openTimingRegion(deviceStream);
             timers->interaction[iloc].fep_k.closeTimingRegion(deviceStream);
           }
           /* Don't launch an empty local FEP kernel (not allowed with CUDA) */
           return;
         }
         ...
         fepConfig.blockSize[2]     = num_threads_z;

         const int bsize = fepConfig.blockSize[0] * fepConfig.blockSize[1] * fepConfig.blockSize[2];
         // one warp per nri
         const int nri_per_block = bsize / warp_size;
         //nblock = (feplist->nri + bsize - 1) / bsize;
         nblock = (feplist->nri + nri_per_block - 1) / nri_per_block;
         ...
         auto*      fepTimingEvent = bDoTime ? timers->interaction[iloc].fep_k.fetchNextEvent() : nullptr;
         const auto fepKernel      = select_nbnxn_fep_kernel(
                 nbp->elecType, nbp->vdwType, stepWork.computeEnergy, &nb->deviceContext_->deviceInfo());
         const auto fepKernelArgs = prepareGpuKernelArguments(fepKernel, fepConfig, adat, nbp, feplist, &stepWork.computeVirial);

         launchGpuKernel(fepKernel, fepConfig, deviceStream, fepTimingEvent, "k_calc_nb_fep", fepKernelArgs);

         // Foreign lambda kernels
         if (nb->n_lambda > 0 && stepWork.computeDhdl && (nbp->alpha_coul != 0 || nbp->alpha_vdw != 0)) {
             ...
             const int blockSize = fepForeignConfig.blockSize[0] * fepForeignConfig.blockSize[1] * fepForeignConfig.blockSize[2];
             // one warp per nri
             const int nri_per_block = blockSize / warp_size;
             nblock = (feplist->nri + nri_per_block - 1) / nri_per_block;
             nblock = calc_nb_kernel_nblock(nblock, &nb->deviceContext_->deviceInfo());
             fepForeignConfig.gridSize[0]  = nblock;
             fepForeignConfig.gridSize[1]      = 1;
             fepForeignConfig.gridSize[2]      = 1;
             fepForeignConfig.sharedMemorySize = (nb->n_lambda + 1) * 2 * sizeof(float);
           ...
           const auto fepForeignKernel = select_nbnxn_foreign_fep_kernel(nbp->elecType, nbp->vdwType, &nb->deviceContext_->deviceInfo());
           const auto fepForeignKernelArgs = prepareGpuKernelArguments(fepForeignKernel, fepForeignConfig, adat, nbp, feplist, &nb->n_lambda);

           launchGpuKernel(fepForeignKernel, fepForeignConfig, deviceStream, fepTimingEvent, "k_calc_nb_fep_foreign", fepForeignKernelArgs);
         }
